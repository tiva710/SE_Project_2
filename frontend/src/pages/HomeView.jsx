...
import { Network, MessageSquare, ZoomIn, ZoomOut, Maximize2, Download, GripVertical } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div ref={containerRef} className="flex-1 flex gap-0 min-h-0 relative">
        {/* Graph Visualization */}
        <div style={{ width: `${splitPosition}%` }} className="bg-gray-800 rounded-l-xl border border-gray-700 overflow-hidden flex flex-col">
          <div className="p-4 border-b border-gray-700 flex items-center justify-between bg-gray-800">
            ...
            <div className="flex items-center gap-2">
              <button className="p-2 hover:bg-gray-700 rounded-lg transition-colors" title="Zoom In">
                <ZoomIn className="w-4 h-4" />
              </button>
              <button className="p-2 hover:bg-gray-700 rounded-lg transition-colors" title="Zoom Out">
                <ZoomOut className="w-4 h-4" />
              </button>
              <button className="p-2 hover:bg-gray-700 rounded-lg transition-colors" title="Fullscreen">
        ...
        {/* Chat Interface */}
        <div className="bg-gray-800 rounded-r-xl border border-gray-700 overflow-hidden flex flex-col" style={{ width: `${100 - splitPosition}%` }}>
